...
public class Cache extends Activity {
    ...
    public Cache(String prefFile, Context appContext) {
        preferences = appContext.getSharedPreferences(prefFile, MODE_PRIVATE);
    }
     ...
     *
     * @param theFolder    the folder path announces you want to save it to e.g "DropBox/WorkImages"
    ...
    private String setupFullPath(String imageName) {
        ...
        return mFolder.getPath() + File.separator + imageName;
    }
